...
public class StaffAdapter extends RecyclerView.Adapter<StaffAdapter.MyViewHolerModule> {

    private ArrayList<DoctorStaffModel> arrayList;
    private Context context;

    public StaffAdapter(ArrayList<DoctorStaffModel> arrayList, Context context) {
    ...
    @Override
    public StaffAdapter.MyViewHolerModule onCreateViewHolder(ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.doctor_staff_list_item, parent, false);

        return new StaffAdapter.MyViewHolerModule(layoutView,context,arrayList);
    }

    @Override
    public void onBindViewHolder(StaffAdapter.MyViewHolerModule holder, int position) {
