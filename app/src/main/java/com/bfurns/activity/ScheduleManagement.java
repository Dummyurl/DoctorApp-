...
/*
        ...
        Utility.showProgressDialog(ScheduleManagement.this, "Please wait...");
...
*/
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        JSONArray arr = jsonObject.getJSONArray("all");
                        for (int i = 0; i < arr.length(); i++) {
                            ...
                            appointmentAdapter = new AppointmentAdapter(arrayList, ScheduleManagement.this);
        ...
        getData.execute(URLListner.BASEURL + URLListner.doctor_all_appointment_merge);
    ...
    private void getApointements() {
        ...
        getData.execute(URLListner.BASEURL + URLListner.doctor_all_appointment);
