...
public class TwoFragment extends android.support.v4.app.Fragment {
    ...
    String user_id, doctor_id,email,clinic_doctor_id,clinic_id,merge_doctor_id,status;
    ...
    private void CommanDetails() {
            ...
            public void success(JSONObject jsonObject) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        JSONArray arr = jsonObject.getJSONArray("months");
        ...
        getData.execute(URLListner.BASEURL + URLListner.doctor_month_appointment_merge);
    ...
    private void getApointements() {
       ...
       Utility.progressDialog.show();
        ...
        getData.execute(URLListner.BASEURL + URLListner.doctor_month_appointment);
