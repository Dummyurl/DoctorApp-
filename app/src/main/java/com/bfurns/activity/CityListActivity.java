...
import com.bfurns.R;
import com.bfurns.adapter.CityListAdapter;
...
public class CityListActivity extends AppCompatActivity {
    ...
    private CityListAdapter appointmentAdapter;
    ...
    private void getcategory() {
        ...
        Utility.showProgressDialog(CityListActivity.this, "Please wait...");
                ...
                try {
                    ...
                    if (success==1) {
                        ...
                        for (int i = 0; i < arr.length(); i++) {
                            ...
                            extrasItemModel.setCity(json.getString("city_id"));
                            extrasItemModel.setCity_name(json.getString("city_name"));


                            arrayList.add(extrasItemModel);


                            appointmentAdapter = new CityListAdapter(arrayList, CityListActivity.this);
        ...
        getData.execute(URLListner.BASEURL + URLListner.get_city);
